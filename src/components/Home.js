                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card bg-warning">
                            <div class="card-body">
                                ...
                                <div class="text-center"><button style={{width:"10rem"}} class="btn btn-lg roundend-3 btn-success mt-5"><a href="https://drive.google.com/file/d/1-97M58MUTv8wz3-DB7erRKXz1Xf0gGtM/view?usp=sharing" target="_blanck" class="text-decoration-none text-white">Resume</a></button></div>
